...
def main():
    ...
    parser.add_argument("path", type = str, help = "The directory with the project")
    parser.add_argument("-u", type = str, required = False, default = "", help = "upstream branch for sub projects; if empty, current upstream branch will be used")
    args = parser.parse_args()
    args.path = Path(args.path)

    make_patches('Test_Big1')
    make_patches('Test_Big2')
